package enset.mohammedia.recipe_web_site.bootstrap;

import enset.mohammedia.recipe_web_site.entities.*;
import enset.mohammedia.recipe_web_site.repositories.CategoryRepository;
import enset.mohammedia.recipe_web_site.repositories.RecipeRepository;
import enset.mohammedia.recipe_web_site.repositories.UnitOfMesureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        //get UOMs
        Optional<UnitOfMesure> eachUomOptional = UnitOfMesureRepository.findByDescription("Mg");

        if(!eachUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMesure> tableSpoonUomOptional = UnitOfMesureRepository.findByDescription("G");

        if(!tableSpoonUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMesure> teaSpoonUomOptional = UnitOfMesureRepository.findByDescription("Kg");

        if(!teaSpoonUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMesure> dashUomOptional = UnitOfMesureRepository.findByDescription("L");

        if(!dashUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMesure> pintUomOptional = UnitOfMesureRepository.findByDescription("Ml");

        if(!pintUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMesure> cupsUomOptional = UnitOfMesureRepository.findByDescription("G");
        ...
        UnitOfMesure pintUom = dashUomOptional.get();
        ...
        Optional<Category> mexicanCategoryOptional = categoryRepository.findByDescription("French");
